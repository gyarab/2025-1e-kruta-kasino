...
public class Casino {
    ...
    public static void main(String[] args) {
                ...
                while (hraruletu && penize > 0) {
                    ...
                    if (sazka <= 0 || sazka > penize) {
                        ...
                        if (typsazky == 1) {
                            ...
                            int[] cerna = {2, 4, 6, 8, 10, 11, 13, 15, 17, 20, 22, 24, 26, 28, 29, 31, 33, 35};

                            boolean jecervena = false;
                            for (int c : cervena) { if (c == vyhernicislo) jecervena = true; }

                            boolean jecerna = false;
                            for (int c : cerna) { if (c == vyhernicislo) jecerna = true; }

                            if (vyhernicislo == 0 && volbabarvy == 3) {
                                System.out.println("Zelená, Vyhráváš.");
                                penize = penize + (sazka * 36);
                            } else if (jecervena && volbabarvy == 1) {
                                System.out.println("Červená, Vyhráváš.");
                                penize = penize + (sazka * 2);
                            } else if (jecerna && volbabarvy == 2) {
        ...
        System.out.println();
        if (penize <= 0) {
            System.out.println("Prohrál jsi všechny peníze.");
        } else {
